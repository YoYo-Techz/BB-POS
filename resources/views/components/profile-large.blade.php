<div class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
    ...
    <div class="relative">
        ...
        <img class="w-40 h-40 rounded-md object-cover"
            src="https://ui-avatars.com/api/?background=random&name={{ $model->nickname }}" alt="User" />
    ...
    <div class="flex flex-col px-6">
        ...
        <div class="flex h-8 flex-row">
            ...
            <a href="https://github.com/EgoistDeveloper/" target="_blank">
                <h2 class="text-lg font-semibold">{{ $model->nickname }}</h2>
            </a>
        ...
        <div class="mt-2 flex flex-row items-center space-x-5">
            ...
            <a href="#"
                ...
                <div class="flex flex-row items-center justify-center">
                    ...
                    <span class="font-bold text-gray-600">{{ $model->wallet->balance ?? 0 }}</span>
                </div>
    ...
    <div class="w-100 flex flex-grow flex-col items-end justify-start">
        <div class="flex flex-row space-x-3">
            <!-- Follow Button -->
            <a wire:navigate href="{{ route('member.agents.edit', $model->nickname) }}"
